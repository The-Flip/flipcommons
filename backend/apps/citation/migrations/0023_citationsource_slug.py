...
# this migration adds the nullable column and backfills it; 0024 adds the
# constraints (including required-slug). Two files so the backfill is
# testable at this frozen state — once 0024 lands, a slugless magazine row
...
# Frozen at authoring time (slug-addressed = magazine), matching the frozen
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='slug',
            field=models.CharField(blank=True, help_text='Authored kebab handle addressing this source in patch cite refs (<magazine-slug>:<issue-slug>, e.g. billboard:1945-09-29). Present exactly on slug-addressed types (magazine); null everywhere else.', max_length=200, null=True, validators=[django.core.validators.RegexValidator(re.compile('^[a-z0-9]+(?:-[a-z0-9]+)*$'), 'Slug may contain only lowercase letters, digits, and hyphens, with no leading, trailing, or repeated hyphens.')]),
        ),
