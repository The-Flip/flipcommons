<!-- @component Display-subtype detail page: description and the games listing pinned to the subtype. -->
<script lang="ts">
...
<GamesSection games={profile.games} q={data.q} pinned={{ display_subtype: profile.slug }} />
