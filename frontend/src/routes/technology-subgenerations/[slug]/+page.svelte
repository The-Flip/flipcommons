<!-- @component Technology-subgeneration detail page: description and the games listing pinned to the subgeneration (direct or via system). -->
<script lang="ts">
...
<GamesSection
  games={profile.games}
  q={data.q}
  pinned={{ technology_subgeneration: profile.slug }}
/>
