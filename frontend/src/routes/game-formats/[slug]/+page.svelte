<!-- @component Game-format detail page: description and the games listing pinned to the format. -->
<script lang="ts">
...
<GamesSection games={profile.games} q={data.q} pinned={{ game_format: profile.slug }} />
