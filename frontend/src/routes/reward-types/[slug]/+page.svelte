<!-- @component Reward-type detail page: description and the games listing pinned to the reward type. -->
<script lang="ts">
...
<GamesSection games={profile.games} q={data.q} pinned={{ reward_type: [profile.slug] }} />
