<!-- @component Technology-generation detail page: description and the games listing pinned to the generation. -->
<script lang="ts">
...
<GamesSection games={profile.games} q={data.q} pinned={{ tech_gen: profile.slug }} />
