...
-- entity_registry (entity_type ↔ content-type label ↔ table) and entity_subjects (the
-- 21-branch UNION), GENERATED by `manage.py export_entity_registry` (`make codegen`).
