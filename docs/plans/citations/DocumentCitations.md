...
**There is nothing to migrate.** The obvious worry is documents already filed as IPDB web children, but of the IPDB root's 2,070 children exactly **one** has a `/files/` PDF URL, carrying one citation. The misfiling this plan prevents has barely happened yet — because until now there was no better place to put a manual.
