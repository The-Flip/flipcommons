...
| **Catalog: edit-history**    | `/{plural}/[public-id]/edit-history`                                                                                                                              | No — re-renders the parent entity's content in raw claim form; nothing for a search engine the detail page doesn't already offer. See the 2026-09 update in [`Sitemap.md`](Sitemap.md).                                  |
| **Catalog: sources**         | `/{plural}/[public-id]/sources`                                                                                                                                   | No — same reasoning as edit-history.                                                                                                                                                                                     |
