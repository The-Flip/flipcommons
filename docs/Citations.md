...
The authored-work create form offers **book, periodical and video**. A video created there is a **movie** — the parentless-citable work — and is root-only: the create endpoint 422s a video `parent_id`, because a flat-hierarchy type's children (a platform's videos, a site's pages) mint from URLs and identifiers through recognition, never by hand.
